...
> [!Caution]
> **Virtual Accessories for Homebridge v3.5.13 breaks the Valve accessory.** The Valve accessory configuration will need to be manually updated. Please refer to this [Wiki page](https://github.com/justjam2013/homebridge-virtual-accessories/wiki/Virtual-Accessories-For-Homebridge-v3.5.13-breaking-update-for-Valve-accessory) for details on how to update the Valve accessory configuration.
